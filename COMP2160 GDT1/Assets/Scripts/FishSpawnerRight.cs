...
public class FishSpawnerRight : MonoBehaviour
{
    ...
    [SerializeField] private Fishright fishright; 
    ...
    private void Update()
    {
        ...
        if (timer <= 0)
        {
            ...
            Fishright newFish = Instantiate(fishright, spawnPosition, Quaternion.identity, transform); 
